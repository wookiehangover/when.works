...
function Mailer(id) {
  this.id = id;
  // TODO: this should take into account the user's timezone
...
Mailer.prototype.sendMail = function(message) {
  // we shoul also thing about storing this somewhere, just in case we want to
  // resend it, like if mandrill ever goes down
...
Mailer.prototype.storeMessage = function(message) {
