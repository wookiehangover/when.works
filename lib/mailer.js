...
function Mailer(id) {
  this.id = id;
  this.start = moment().startOf('day').subtract(6, 'hour');
  this.end = moment().endOf('day').add(6, 'hour');
...
Mailer.prototype.formatAvailability = function (freebusy) {
  ...
  var config = new Config({
    ...
    timeMin: moment().tz(timezone).startOf('day').format(),
    timeMax: moment().tz(timezone).endOf('day').format()
  }, {
